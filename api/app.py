...
from api.telemetry import router as _telemetry_router
from api.ab_testing import router as _ab_router
from api.quota import router as _quota_router
from api.scheduler import router as _scheduler_router
from api.dependency import router as _dependency_router
from api.health_monitor import router as _health_monitor_router
from api.circuit_breaker import router as _circuit_router
from api.retry_policy import router as _retry_router
from api.bulkhead import router as _bulkhead_router
from api.skill_config import router as _skill_config_router
from api.skill_tags import tags_router as _tags_router, taggings_router as _taggings_router
from api.skill_ratings import ratings_router as _ratings_router
from api.feature_flags import flags_router as _flags_router
from api.maintenance import maintenance_router as _maintenance_router
from api.operator_notes import notes_router as _notes_router
from api.sla import sla_router as _sla_router
...
app.include_router(_dependency_router)
app.include_router(_health_monitor_router)
app.include_router(_circuit_router)
app.include_router(_retry_router)
app.include_router(_bulkhead_router)
app.include_router(_skill_config_router)
app.include_router(_tags_router)
app.include_router(_taggings_router)
app.include_router(_ratings_router)
app.include_router(_flags_router)
