...
├── test_api.py               # 31 — REST endpoints incl. station+nonexistent-skill branch, absolute path, available_services override
...
Run: `python -m pytest` — 622 tests, all passing.
