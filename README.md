...
├── test_acceptance.py        # 50 — 39 YAML scenarios + AcceptanceMiddleware topics, _run_test edges, legacy inject, pickplace adapter branches, main() CLI
...
Run: `python -m pytest` — 574 tests, all passing.
