...
# SLA policies
python etd_cli.py sla set etd.pickplace.basic --max-p95-ms 2000 --min-success-rate 0.95
python etd_cli.py sla set etd.hyundai.wia_welding --max-p95-ms 5000
python etd_cli.py sla list
python etd_cli.py sla get etd.pickplace.basic
python etd_cli.py sla remove etd.pickplace.basic

# Operator notes
python etd_cli.py notes add etd.hyundai.wia_welding "Torch calibration due Q3" --category runbook --author ops-team
python etd_cli.py notes add robot-01 "Wrist joint shows intermittent slip" --category issue
python etd_cli.py notes list
python etd_cli.py notes list --subject etd.hyundai.wia_welding
python etd_cli.py notes list --category issue
python etd_cli.py notes subjects
python etd_cli.py notes update <note-id> --text "Updated text" --category warning
python etd_cli.py notes remove <note-id>

# Maintenance windows
python etd_cli.py maintenance add etd.hyundai.wia_welding 2026-06-01T02:00:00+00:00 2026-06-01T04:00:00+00:00 --reason "Firmware upgrade"
python etd_cli.py maintenance add '*' 2026-06-01T00:00:00+00:00 2026-06-01T01:00:00+00:00 --reason "Global patching"
python etd_cli.py maintenance list
python etd_cli.py maintenance list --active
python etd_cli.py maintenance check etd.hyundai.wia_welding
python etd_cli.py maintenance remove <window-id>

# Feature flags
python etd_cli.py flag set '*' enable_force_feedback false --description "Global default off"
python etd_cli.py flag set etd.pickplace.basic enable_force_feedback true
python etd_cli.py flag set etd.pickplace.basic enable_force_feedback false --node robot-maint-01
python etd_cli.py flag resolve etd.pickplace.basic enable_force_feedback
python etd_cli.py flag resolve etd.pickplace.basic enable_force_feedback --node robot-maint-01
python etd_cli.py flag list
python etd_cli.py flag list --skill etd.pickplace.basic
python etd_cli.py flag get etd.pickplace.basic enable_force_feedback
python etd_cli.py flag remove etd.pickplace.basic enable_force_feedback

# Skill ratings
python etd_cli.py rating add etd.pickplace.basic 5 --comment "Solid, reliable" --operator ops-team
python etd_cli.py rating add etd.hyundai.wia_welding 4
python etd_cli.py rating list
python etd_cli.py rating list --skill etd.pickplace.basic
python etd_cli.py rating stats etd.pickplace.basic
python etd_cli.py rating stats etd.pickplace.basic --json
python etd_cli.py rating skills
python etd_cli.py rating remove <rating-id>
...
# POST http://localhost:8000/ratings  {"skill_id": "etd.pick", "rating": 5, "comment": "great"}
# GET  http://localhost:8000/ratings/stats/etd.pick
# GET  http://localhost:8000/ratings/skills
# DELETE http://localhost:8000/ratings/{rating_id}
# GET  http://localhost:8000/flags
# POST http://localhost:8000/flags  {"skill_id": "etd.pick", "flag_key": "ff", "enabled": true}
# GET  http://localhost:8000/flags/resolve?skill_id=etd.pick&flag_key=ff&node_id=r1
# GET  http://localhost:8000/flags/etd.pick/ff
# DELETE http://localhost:8000/flags/etd.pick/ff
# GET  http://localhost:8000/maintenance
# POST http://localhost:8000/maintenance  {"skill_id": "etd.pick", "start_at": "...", "end_at": "..."}
# GET  http://localhost:8000/maintenance/check?skill_id=etd.pick
# DELETE http://localhost:8000/maintenance/{window_id}
# GET  http://localhost:8000/notes
# POST http://localhost:8000/notes  {"subject": "etd.pick", "text": "...", "category": "issue"}
# GET  http://localhost:8000/notes/subjects
# PATCH http://localhost:8000/notes/{note_id}  {"text": "updated"}
# DELETE http://localhost:8000/notes/{note_id}
# GET  http://localhost:8000/sla/policies
# POST http://localhost:8000/sla/policies  {"skill_id": "etd.pick", "max_p95_ms": 2000, "min_success_rate": 0.95}
# GET  http://localhost:8000/sla/policies/etd.pick
# POST http://localhost:8000/sla/evaluate/etd.pick  {"executions": [{"status": "success", "total_duration_ms": 1200}]}
...
├── test_skill_ratings.py       # 48 — RatingEntry (defaults/round-trip/to_dict-keys/from_dict-defaults), RatingStats (to_dict-keys), RatingStore CRUD (empty/add/comment-operator/invalid-0/invalid-6/invalid-negative/get/get-unknown/list-all/list-filtered/list-empty-filter/remove/remove-unknown/count/rated-skills-sorted/dedup), stats (none/single/mean-rounded/distribution-keys/distribution-counts/independent-per-skill/count), persistence (persist/create-dir/corrupt-empty), REST API /ratings (list-empty/add-201/has-rating-id/has-skill-id/zero-422/six-422/list-after/filter-skill/get/get-404/stats/stats-404/distribution/delete/delete-404/removes/rated-skills/rated-skills-empty)
├── test_feature_flags.py       # 59 — _make_key (no-node/with-node/global), FlagEntry (defaults/round-trip/to_dict-keys/from_dict-defaults), FeatureFlagStore CRUD (empty/set-creates/set-updates/set-updates-description/set-empty-description-preserves/get-exact/get-unknown/get-with-node/remove/remove-unknown/remove-node/count/list-all/list-filtered/list-empty), resolution (default-false/skill-enabled/global-fallback/skill-overrides-global/node-overrides-skill/node-overrides-global/skill-fallback-no-node/global-fallback-no-skill/independent-skills/global-no-bleed), resolve_source (default/global/skill/node/skill-wins-over-global), persistence (flags/node-flag/create-dir/corrupt-empty), REST API /flags (list-empty/set-201/set-200/has-skill-id/has-enabled/list-after/filter/get/get-404/get-node/resolve-default/resolve-skill/resolve-global/resolve-node/delete/delete-404/removes/delete-node)
├── test_maintenance.py         # 50 — MaintenanceWindow (defaults/round-trip/to_dict-keys/from_dict-defaults/is_active-before/during/at-start/at-end/after), MaintenanceStore CRUD (empty/add/all-fields/invalid-end-before/invalid-end-equals/get/get-unknown/remove/remove-unknown/count/list-all/list-filtered/list-active/active-windows), is_in_maintenance (false-no-windows/false-before/true-during/false-after/false-other-skill/global-wildcard/node-specific/no-match-other-node/no-node-window-any-node/no-arg-none-window/multiple-any-match), persistence (persist/create-dir/corrupt-empty), REST API /maintenance (list-empty/add-201/has-id/has-skill/invalid-422/list-after/filter/get/get-404/check/delete/delete-404/removes)
├── test_operator_notes.py      # 49 — VALID_CATEGORIES, OperatorNote (defaults/round-trip/to_dict-keys/from_dict-defaults), NoteStore CRUD (empty/add/all-fields/invalid-category/all-valid-cats/get/get-unknown/update-text/update-category/update-none-unchanged/update-unknown/update-bad-category/remove/remove-unknown/count/list-all/filter-subject/filter-category/filter-both/subjects-sorted/subjects-dedup/subjects-empty), persistence (persist/create-dir/corrupt-empty), REST API /notes (list-empty/add-201/has-id/has-subject/bad-cat-422/list-after/filter-subject/filter-category/get/get-404/update/update-category/update-404/update-bad-422/subjects-empty/subjects-after/delete/delete-404/removes)
└── test_sla.py                 # 53 — _percentile (empty/single/p50/p100/p0), SLAPolicy (defaults/round-trip/to_dict-keys/from_dict-defaults), SLAViolation (to_dict-keys), SLAResult (to_dict-keys/compliant-flag), SLAStore CRUD (empty/set-creates/set-updates/invalid-rate/invalid-negative/get/get-unknown/remove/remove-unknown/list/count), evaluate (no-policy-none/empty-no-violations/all-success/rate-violation/latency-violation/both-violations/no-latency-target/no-rate-target/p95-computed/sample-count/skill-id/no-duration-excluded/compliant-within-limit), persistence (persist/create-dir/corrupt-empty), REST API /sla (list-empty/set-201/set-200/has-skill-id/rate-422/list-after/get/get-404/delete/delete-404/evaluate-no-policy/evaluate-compliant/evaluate-violation/evaluate-sample-count)
...
├── test_health_monitor.py      # 69 — HealthThresholds (defaults/round-trip/from_dict/to_dict-keys), SkillHealthReport (to_dict-keys/rate-rounded), NodeHealthReport (skills_executed), HealthAlert (round-trip/resolved-fields), AlertStore (empty/add-get/active-excludes-resolved/resolve-false-unknown/idempotent/persist/corrupt-empty), HealthMonitor._classify (unknown/healthy/degraded-rate/critical-rate/degraded-streak/critical-streak), ._failure_streak (no-failures/streak-tail/broken-by-success/aborted-counts), .check_skill (unknown/healthy/degraded/critical/streak/last_run/skill_id/window_hours), .check_node (unknown/healthy/skills_executed/node_id), ._maybe_alert (healthy-None/unknown-None/warning/critical/no-duplicate/new-after-resolve), .check_fleet (healthy/worst-wins/generated_at/to_dict), alert-management (active-empty/resolve-true/resolve-false-unknown/all-includes-resolved), REST API /monitor (skills-empty/after-records/single-healthy/unknown-no-records/window-param, nodes-empty/single/unknown, fleet-200/overall-status/healthy/critical, alerts-empty/triggered/resolve-404/resolve-200/all-param)
...
Run: `python -m pytest` — 2446 tests, all passing.
