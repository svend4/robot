...
├── test_cli.py               # 42 — stations command, install not-found, _check_station_entry(None), chained --family+--free filter, missing requiredServices → else []
...
Run: `python -m pytest` — 611 tests, all passing.
