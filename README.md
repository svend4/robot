...
├── etd_cli.py                          # CLI: validate, install, stations, info, revoke, audit-log, validate-context, rollout, token, versions, review, sandbox-check
...
Run: `python -m pytest` — 1047 tests, all passing.
