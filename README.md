...
├── test_marketplace.py       # 36 — skill_store __main__ block, validation_failed reason, __init__ exports, missing licensing_policy → {}
...
├── test_acceptance.py        # 71 — 39 YAML scenarios + AcceptanceMiddleware topics, _run_test edges, adapter safety branches (exo/cobot/wia/mobed/assembly/inspect/atlas), main() CLI, missing status/reason in expect → checks skipped
...
Run: `python -m pytest` — 615 tests, all passing.
